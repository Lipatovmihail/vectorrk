      ...
      WebApp: {
        ...
        BiometricManager: {
          ...
          requestAccess(params: {
            reason?: string;
          }, callback?: (error: string | null, granted: boolean) => void): void;
          authenticate(params: {
            reason?: string;
          }, callback?: (error: string | null, token: string, status: string) => void): void;
          updateBiometricToken(token: string, callback?: (error: string | null, updated: boolean) => void): void;
          openSettings(): void;
        };
